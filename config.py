...
Есть ли поваленные деревья или сухостой.
Если есть явные повреждения или часть дерева засохла, то верни их bbox в формате: [x_min, y_min, w, h]. Координаты нормализованные. Если таких нет то верни [].

Формат вывода:
description: "твое описание"
bboxs: список bbox: [[x_min, y_min, w, h]], [x_min, y_min, w, h]]]
defects: список дефектов, соотвествующих bbox: трещина, дупло
